...
public interface TransactionRepository extends JpaRepository<Transaction, Integer> {
    ...
    public ArrayList<Transaction> findTransactionSendersByConnectionId(@Param("id") Integer id);
    ...
    public ArrayList<Transaction>  findTransactionReceiversByConnectionId(@Param("id") Integer id);
    ...
    public ArrayList<Transaction>  findTransactionsByConnectionId(@Param("id") Integer id);
